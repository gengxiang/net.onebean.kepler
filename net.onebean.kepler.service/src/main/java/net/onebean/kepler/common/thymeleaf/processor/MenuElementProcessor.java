package net.onebean.kepler.common.thymeleaf.processor;

import net.onebean.component.SpringUtil;
import net.onebean.kepler.common.thymeleaf.base.OneBeanBaseAbstractElementTagProcessor;
import net.onebean.kepler.service.SysPermissionService;
import net.onebean.kepler.service.impl.SysPermissionServiceImpl;
